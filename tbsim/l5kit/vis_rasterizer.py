...
class VisualizationRasterizer(object):
    """
    Rasteriser for visualization purposes
    """
    ...
    def rasterize(
        ...
        return sem_im.astype(float32) / 255
    ...
    def render_semantic_map(
        ...
        lanes_mask: Dict[str, np.ndarray] = defaultdict(lambda: np.zeros(len(lane_indices) * 2, dtype=bool))
